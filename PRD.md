# SheetCRM - Product Requirements Document

## 1. Product Overview

**SheetCRM** là một ứng dụng quản lý quan hệ khách hàng (CRM) nhẹ, được thiết kế đặc biệt cho **doanh nghiệp siêu nhỏ và hộ kinh doanh cá nhân** tại Việt Nam.

Điểm độc đáo của SheetCRM là sử dụng **Google Sheets làm database**, cho phép người dùng:
...
| SheetCRM.io | Feature set for small business |
